        ...
        return ft.Card(
            content=ft.Container(
                content=ft.Column([
                    ...
                    ft.Text("Total Impact: 0.0 kg CO2", size=11, color=ft.Colors.GREY_600)
                ], spacing=5, horizontal_alignment=ft.CrossAxisAlignment.CENTER),
                padding=15
            ),
            elevation=3,
...
class EcoTrackerApp:
    ...
    def run(self, page: ft.Page):
        ...
        page.title = "Round-2-Eco Tracker"
    ...
    def _update_impact_display(self):
        ...
        self.impact_card.content.content.controls[2].value = f"🌍 CO2 Saved: {weekly_impact.co2_saved_kg:.1f} kg"
        self.impact_card.content.content.controls[3].value = f"⛽ Gas Saved: {weekly_impact.gas_saved_gallons:.1f} gallons"
        self.impact_card.content.content.controls[4].value = f"🌳 Trees Equivalent: {weekly_impact.trees_equivalent}"
    
        self.impact_card.content.content.controls[6].value = f"Total Impact: {total_impact.co2_saved_kg:.1f} kg CO2"
